      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        {isError && (
          <div className="flex flex-col items-center justify-center py-20 text-red-400">
            <p className="text-sm font-medium">Failed to load students. Please check your connection.</p>
          </div>
        )}
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="text-center px-6 py-4 text-xs font-semibold text-slate-400 uppercase tracking-wider">Actions</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={student.id} className="border-b border-gray-50 hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 capitalize">{student.gender}</p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-500 truncate max-w-[180px]">{student.email}</p>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-start gap-1.5 text-sm text-slate-600">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-slate-500 capitalize">{student.state}</p>
                        </div>
                      </div>
                    </td>
